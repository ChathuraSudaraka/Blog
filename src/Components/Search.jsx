...
function Search({ selectedTag }) {
  ...
  return (
    ...
    px-[70] md:px-[150px]"
    >
      <img src="https://media.istockphoto.com/id/1174411817/photo/banner-with-copyspace-in-grey-color-of-laptop-and-female-hands-blue-background.jpg?s=612x612&w=0&k=20&c=1sflGCIsdv7Bi6s10TXP_PhR8xn2kje5XFF8NKw3Oss=" className="rounded-2xl " />
      <div
